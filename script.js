...
// Function to fetch response from API using the new endpoint
async function fetchResponse(userMessage) {
  try {
    ...
    // Extract response text (assuming the API returns data.response)
    return data.response || JSON.stringify(data).slice(0, 200) + "...";
  } 
  catch (error) {
